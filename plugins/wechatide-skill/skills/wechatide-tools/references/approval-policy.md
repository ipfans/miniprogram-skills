...
高信号动作至少能说明：用了哪个工具、做了什么、返回了什么。失败时原样抛出错误，不要吞掉或猜测修复。`PROJECT_PATH_NOT_FOUND` / `PROJECT_CONFIG_JSON_ERROR` / `APPID_ERROR` 见 [project-tool-error-guide.md](project-tool-error-guide.md)。
